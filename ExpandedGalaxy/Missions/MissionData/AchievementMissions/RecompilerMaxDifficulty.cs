...
{
    public class RecompilerMaxDifficulty
    {
        ...
        public static PickupMissionData CreateData()
        {
            ...
            pickupMissionData.OriginalName = "ExGal_RecompilerMaxDiff_Hidden";
